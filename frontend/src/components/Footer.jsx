                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1.5fr 1fr 1fr 1.5fr', gap: '80px', marginBottom: '80px' }}>
                    ...
                    <div>
                        ...
                        <form style={{ display: 'flex', gap: '10px', marginBottom: '30px' }} onSubmit={(e) => e.preventDefault()}>
                            <input type="email" placeholder="Email address" style={{ flex: 1, background: '#000', border: '1px solid var(--border)', padding: '12px 15px', borderRadius: '4px', color: '#fff', fontSize: '0.85rem' }} />
                            <button className="btn btn-primary" style={{ padding: '12px 20px', fontSize: '0.7rem' }}>Join</button>
                        </form>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '15px', opacity: 0.6 }}>
                            <img src="https://img.icons8.com/color/48/000000/visa.png" width="30" style={{ filter: 'grayscale(1) brightness(1.5)' }} alt="visa" />
                            <img src="https://img.icons8.com/color/48/000000/mastercard.png" width="30" style={{ filter: 'grayscale(1) brightness(1.5)' }} alt="mastercard" />
                            <img src="https://img.icons8.com/color/48/000000/apple-pay.png" width="30" style={{ filter: 'grayscale(1) brightness(1.5)' }} alt="applepay" />
                            <div style={{ marginLeft: 'auto', border: '1px solid var(--border)', padding: '4px 8px', borderRadius: '4px', fontSize: '0.6rem', fontWeight: 900, color: 'var(--accent)' }}>CERTIFIED 2026</div>
                        </div>
                    </div>
                </div>
